...
Game.launch = function(canvasId)
{
	...
	var draw = function(screen, gameSize, clockticks)
	{
		if (gameMode === 1)
		{
			...
			screen.fillRect(0, 0, gameSize.x, gameSize.y-2*TileSize-16-20);
